...
class InputReader {
    companion object {
        ...
        fun parseDayEighteenInput(): List<String> {
            val input = {}.javaClass.getResource("/input_18.txt")?.readText() ?: ""
            return input.lines().dropLast(1)
        }

        fun parseDayNineteenInput(): List<String> {
            val input = {}.javaClass.getResource("/input_19.txt")?.readText() ?: ""
            return input.lines().dropLast(1)
        }

        fun parseDayTwentyInput(): List<String> {
            val input = {}.javaClass.getResource("/input_20.txt")?.readText() ?: ""
            return input.lines().dropLast(1)
        }

        fun parseDayTwentyTwoInput(): List<String> {
        ...
        fun parseDayTwentyFourInput(): List<String> {
            val input = {}.javaClass.getResource("/input_24.txt")?.readText() ?: ""
            return input.lines().dropLast(1)
        }

        fun parseDayTwentyFiveInput(): List<String> {
            val input = {}.javaClass.getResource("/input_25.txt")?.readText() ?: ""
            return input.lines()
        }
    }
}